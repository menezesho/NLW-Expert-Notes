...
export function NewNoteCard(props: NewNoteCardProps) {
    ...
    function handleStartRecording() {
        ...
        if (!isSpeechRecognitionAPIAvailable){
            toast.error("Seu navegador não suporta esta funcionalidade de gravação de áudio!")
        ...
        speechRecognition.lang = 'pt-BR' // The language of the current speech recognition
        speechRecognition.continuous = true // Will listen for as long as the user speaks
        speechRecognition.maxAlternatives = 1 // The maximum number of alternative transcripts
        speechRecognition.interimResults = true // Will return interim results
    ...
    function handleStopRecording(event: React.MouseEvent<HTMLButtonElement, MouseEvent>) {
        event.preventDefault()
